...
local commands = { "DbRun", "DbDDL", "DbTables", "DbColumns", "DbSnapshot", "DbDiff", "DbPath", "DbDanger", "DbConn", "DbExport", "DbExplain", "DbExplainJson", "DbIndexes", "DbFk", "DbTableSize", "DbHistoryRun", "DbHistoryPick" }
